    ...
    <div class="row">
        <div class="pr-lg-0 col-12 col-lg-7 w-100 d-flex justify-content-center justify-content-lg-end">
            <ul class="pagination d-md-flex d-none">
                <li class="page-item" :class="{disabled: currentPage == 1}" :aria-disabled="useEdgeLink && currentPage == 1"><a class="page-link" href="#" @click="change(1)">«</a></li>
                ...
                <li class="page-item" :class="{disabled: currentPage == lastPage}" :aria-disabled="useEdgeLink && currentPage == lastPage"><a class="page-link" href="#" @click="change(lastPage)">»</a></li>
            </ul>
