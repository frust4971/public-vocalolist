...
@section('contents')
    ...
    @endif
    <div class="row">
        <div class="pr-lg-0 col-12 col-lg-7 w-100 d-flex justify-content-center justify-content-lg-end">{{$vocalovideos->appends($queries)->links('vendor.pagination.ranking_pagination_view')}}</div>
    </div>
    <br>
    <div class="row">
        <div class=" col-lg-7">
                ...
                <div class="card-body">
                    ...
                    @foreach(config('const.VOCALOIDS') as $VOCALOID)
                        <?php 
                            ...
                            if(!isset($vocaloid_queries['vocaloid']) or $vocaloid_queries['vocaloid'] != $VOCALOID){
