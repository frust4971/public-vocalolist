...
<div class="comment">
    ...
    <p>アクセス数が増えるとモチベーションも上がるので、こんな機能が欲しいなどがあったらブックマークに登録してくれるとそのうち対応する</p>
...
<div class="content mb-5">
    ...
    <h5>最近話題のボカロ</h5>
    <div class="ml-lg-1">
        <p>直近で再生回数10万越えのボカロ動画を表示するページ。最近の流行りを抑えたいならとりあえずここ<br>なるべくボカロ以外の動画が入らないよう工夫はしたけど、たまにボカロ以外の動画が入ったり、ボカロで10万超えてるのに動画が入ってないということもある。そういう動画が見つかり次第判定条件は改善していく予定</p><br>
    </div>
    <h5>ボカロガチャ</h5>
    <div class="ml-lg-1">
