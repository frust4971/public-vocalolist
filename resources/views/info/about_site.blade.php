...
<div class="content my-5">
    ...
    <div class="ml-lg-1">
        <p>YouTubeにあるボカロの歴代ランキングを表示するページです<br><br>半年に一回、二日に分けて更新します<br>なぜかっていうと動画が多すぎていっぺんに更新処理をしようとすると、Googleさんが<br><br>「君ぃ、ちょっとサイトに負荷かけすぎじゃない？」<br><br>って言ってくるから<br><br></p>
    </div>
