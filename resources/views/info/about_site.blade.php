...
<div class="comment">
        ...
        <div class="content mb-5">
            ...
            <p>YouTubeで「ボカロ」や「VOCALOID」と検索してタイトルでランキングとかメドレーとかはいているものを抜いて集めるという流れ</p>
            <h5>歴代ランキング</h5>
            <div class="row ml-2">
        ...
        <div class="content mb-5">
            ...
            <p>YouTubeで「ボカロ　歌ってみた」、「ボカロ　cover」と検索し、タイトルで関係なさそうな動画を判定して収集という流れ<br><br>判定条件が難しすぎるのでボカロ動画より甘め、現在のNGワードはこんなかんじ</p>
            <div class="card">
                <div class="card-body">ランキング、メドレー、替え歌、再生</div>
            </div><br><br>
            <h5>最近話題の歌ってみた</h5>
            <div class="row ml-2">
                <p>直近で再生回数10万越えの動画を表示するページ。ボカロかどうかの判定が難しいので違う動画がよく入ると思われる。今の条件よりいい条件が見つかったら教えてほしい</p>
            </div>
