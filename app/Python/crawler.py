...
ng_word = re.compile('.*(字幕|ランキング|メドレー|替え歌|再生|検定|クイズ|テスト|なボカロ|演奏|ボカロP|top\d|踊ってみた|手描き|太鼓|叩いて|弾い|人力|mmd|mad|プロセカ|TV|ピアノ|combo|プロモ|コスプレ|しりとり|歌詞|プレイ|リアクション|sub|まとめ|再現|絵師|生放送|shorts|ゲームサイズ|アート展|(映像|一部)公開|デビュー|神回|リメイク|【中文】|version|CHUNITHM|イラスト).*', re.IGNORECASE)
