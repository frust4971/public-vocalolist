...
ng_word = re.compile('.*(ランキング|メドレー|替え歌|再生|検定|クイズ|テスト|OP|なボカロ|演奏|ボカロP|top|踊ってみた|手描き|太鼓|弾い|人力|OP|mmd|mad|プロセカ|TV|ピアノ|combo|プロモ|コスプレ|しりとり|歌詞|プレイ|リアクション|sub).*', re.IGNORECASE)
