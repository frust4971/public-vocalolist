...
if __name__ == "__main__":
    ...
    crawler.crawl_and_insert_into_db(const.RECENTLY_VOCALO_TABLE_NAME, "ロウワー", "short", filter_view_count, recently_vocalo_published_after, recently_vocalo_published_before,num_search=max_results_by_view_count)
