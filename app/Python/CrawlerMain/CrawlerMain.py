...
if __name__ == "__main__":
    ...
    Crawler.crawlAndInsertToDB("recently_famous_vocalovideos", "ボカロ", False, "short", 100000, recently_vocalo_published_after, recently_vocalo_published_before)
    Crawler.crawlAndInsertToDB("recently_famous_vocalovideos","ボカロ",False,"medium",100000,recently_vocalo_published_after,recently_vocalo_published_before,must_disconnect_db=True)
